const app = new Vue({
    ...
    methods: {
        ...
        fetchData: function (page) {
            ...
            (async () => {
                const { status, message, data } = await axios.get(appDomain + '/cms/tag/data').then(function (response) {
        ...
        editData: function (id) {
            ...
            try {
                ...
                (async () => {
                    ...
                    const { status, message, data } = await axios.get(appDomain + '/cms/tag/edit/' + id).then(function (response) {
