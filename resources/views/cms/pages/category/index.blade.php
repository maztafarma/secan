...
<div id="categoryManager" class="">
    ...
    @include('cms.pages.category.form')
                            ...
                            <div class="card-box table-responsive">
                                <div id="datatable_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap no-footer">
                                    <div class="row m-b-30">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="button" class="btn btn-secondary f-right text-08rem" @click="showForm">Add Category</button>
                                        </div>
                                    </div>
